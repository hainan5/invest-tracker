  ...
  return (
    <section id="fed-rate" className="mb-8 overflow-hidden rounded-2xl border border-[#ddd9ce] bg-[#faf9f5] p-6 lg:grid lg:grid-cols-[1fr_0.8fr] lg:gap-10 lg:p-7">
      <div>
        ...
        <p className="mt-3 text-[11px] text-[#8b908c]">报告日期 {data.date} · 免费数据可能晚于 CME 实时工具</p>
      </div>
      <div className="mt-7 space-y-5 border-t border-[#e0ddd3] pt-7 lg:mt-0 lg:border-l lg:border-t-0 lg:pl-10 lg:pt-1">
        ...
        <a href={data.sourceUrl} target="_blank" rel="noreferrer" className="inline-flex text-xs font-medium text-[#806225] underline decoration-[#c8b27e] underline-offset-4">查看金十转引的 CME FedWatch 原文</a>
      </div>
    </section>
  );
}